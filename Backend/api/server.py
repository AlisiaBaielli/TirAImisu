...
from Backend.medications.repository import get_current_medications, add_medication, get_medication_events, upsert_scanned_medication
...
def create_medication(payload: MedicationCreate) -> dict:
    ...
    # Calendar creation disabled (commented out) per request
    # try:
    #     ...
    # except Exception:
    #     pass
